...
import Culturalchange from "../../src/components/admin/cultural/change";
...
import "../../src/components/admin/user/user-change.css";
import "../../src/components/admin/cultural/new/cultural-new.css";
import "../../src/components/admin/cultural/change/cultural-change.css";
...
export default function culturalnew() {
  return (
    <div>
      <Head>
        <title>Tiktok Web Site - Change Cultural</title>
        <link rel="icon" href="/assents/icons/favicon.png" />
      </Head>
      <Menu></Menu>
      <Culturalchange></Culturalchange>
      <style jsx global>{`
        body {
          margin: 0;
          padding: 0;
