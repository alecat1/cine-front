...
import Newsfeednew from "../../src/components/admin/newsfeed/new";
...
export default function newsfeednew() {
  return (
    <div>
      <Head>
        <title>Tiktok Web Site - Manage Newsfeed</title>
        <link rel="icon" href="/assents/icons/favicon.png" />
      </Head>
      <Menu></Menu>
      <Newsfeednew></Newsfeednew>
      <style jsx global>{`
        body {
          margin: 0;
          padding: 0;
