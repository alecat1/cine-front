...
import SurveyMod from "../src/components/surveyMod";
...
import "../src/components/surveyMod/surveyMod.css";
...
export default function surveymod() {
  return (
    <>
      <Head>
        <title>Tiktok Web Site - Moderator Survey</title>
