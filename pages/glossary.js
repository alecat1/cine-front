...
import Words from "../src/components/word";
...
import "../src/components/admin/videos/change/videos-change.css";export default function glossary() {
  return (
    <div>
      <Head>
        <title>Tiktok Web Site - Glossary</title>
