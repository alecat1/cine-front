...
import Argentina from "../../src/components/cultural/argentina/argentina";
...
export default function CulturalArgentina() {
  return (
    <div>
      <Head>
        <title>Tiktok Web Site - Cultural - Argentina</title>
