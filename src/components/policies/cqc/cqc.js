  ...
  renderList = () => {
    ...
    if (this.state.policies.length >= 1) {
      ...
      var AcordionPolicies = uniqueSubPolicies.map((poli, i) => {
        ...
        return (
          <Card key={i} onContextMenu={(e)=> e.preventDefault()} onDragStart={(e)=> e.preventDefault()}>
            <Card.Header>
            ...
            <Accordion.Collapse eventKey={i}>
              <Card.Body>
                {arrsubpoli.map((value, j) => {
                  return (
                    <Row className="border-card" key={j}>
                      <Col lg={8} xl={8}>
                      ...
                      <Col lg={4} xl={4} className="outerDiv border-card-left">
                        ...
                        {uniqueVideos && (uniqueVideos.map((video) => {
                        ...
                        <div>
                          <p className="no-sel">
                            ...
                            <Moment format="D-MMM-YYYY" withTitle>{value.updated}</Moment>
                          </p>
                        </div>
                      </Col>
                    </Row>
