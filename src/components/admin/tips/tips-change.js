...
import "./tips-change.css";
import Global from "../../../global";
var jwtDecode = require("jwt-decode");
const cookies = new Cookies();
import Page from "react-page-loading";
import swal from "sweetalert";
class tipsChange extends Component {
  state = {
    selectedFile: null,
  ...
  onClickUpload = (e) => {
    ...
    if (this.state.lob != null) {
      data.append("file", this.state.selectedFile);
      data.append("lob", this.state.lob);
      axios.post(Global.url + "upload-pdf-tips/", data).then((res) => {
        if (res.status == 200) {
      ...
      swal("Error!", "Error, please select any lob", "error");
    }
  };
  onClickDelete = (e) => {
    swal({
      ...
      return (
        <div className="container-admin">
          ...
          <Row className="ml-2 mr-2">
            ...
            <Col lg={6} xl={6}>
              <p className="description-p">Select the tips you want to delete on the Daily Tips page.</p>
              ...
              <Select options={this.state.lobini} styles={this.customStyles} placeholder="Select..." onChange={this.onChangeButtonLob} />
              <Row>
                <Col>
                  <form>
